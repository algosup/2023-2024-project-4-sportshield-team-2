...
| b | 1st Weekly Report | Robin DEBRY (Project Manager) | Grégory PAGNOUX (Quality Assurance)  | 15/03/2024 | 15/03/2024 |
...
| i | 6th Weekly Report | Robin DEBRY (Project Manager) | Grégory PAGNOUX (Quality Assurance)  | 19/04/2024 | XX/03/2024 |
| j | User Manual | Enzo GUILLOUCHE (Technical Writer) | Grégory PAGNOUX (Quality Assurance), | 10/04/2024 | XX/0X/2024 |
...
- naming variables (without magic chapins[^7])
```C++
[Fact]
...
"1001" is a magic chaplins and must be defined using a constant such as :
```const string MAXIMUM_RESULT = "1001";```
```Action actual = () => stringCalculator.Add(MAXIMUM_RESULT);```)
